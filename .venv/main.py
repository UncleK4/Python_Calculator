...
class CalcApp(QWidget):
    def __init__(self):
        ...
        for text in self.buttons:
            ...
            button.setStyleSheet("QPushButton {font: 29pt Helvetica; padding: 13px}")
        ...
        self.clear.setStyleSheet("QPushButton {font: 29pt Helvetica; padding: 13px}")
        self.delete.setStyleSheet("QPushButton {font: 29pt Helvetica; padding: 13px}")
        ...
        master_layout.setContentsMargins(26, 26, 26, 26)
